...
pub type clap_fd_flags = i32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct clap_plugin_posix_fd_support {
    pub on_fd: unsafe extern "C" fn(plugin: *const clap_plugin, fd: i32, flags: clap_fd_flags),
}
...
pub struct clap_host_posix_fd_support {
    pub register_fd:
        unsafe extern "C" fn(host: *const clap_host, fd: i32, flags: clap_fd_flags) -> bool,
    pub modify_fd:
        unsafe extern "C" fn(host: *const clap_host, fd: i32, flags: clap_fd_flags) -> bool,
